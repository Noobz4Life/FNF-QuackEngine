...
class DiscordClient
{
	...
	private static final _defaultID:String = "1141951587082842123";
	...
	public static function changePresence(?details:String = 'In the Menus', ?state:Null<String>, ?smallImageKey : String, ?hasStartTimestamp : Bool, ?endTimestamp: Float)
	{
		...
		presence.largeImageText = "Engine Version: " + states.MainMenuState.quackEngineVersion + " ( Psych " + states.MainMenuState.psychEngineVersion + " )";
