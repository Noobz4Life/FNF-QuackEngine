...
class DiscordClient
{
	...
	private static var _defaultID:String = "1141951587082842123";
	...
	public static function changePresence(details:String, state:Null<String>, ?smallImageKey : String, ?hasStartTimestamp : Bool, ?endTimestamp: Float)
	{
		...
		_options.largeImageText = "Engine Version: " + states.MainMenuState.quackEngineVersion + " ( Psych " + states.MainMenuState.psychEngineVersion + " )";
