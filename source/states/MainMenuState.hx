...
class MainMenuState extends MusicBeatState
{
	...
	public static var nubzEngineVersion:String = '0.1'; //This is also used for Discord RPC
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 64, 0, "Nubz Engine v" + nubzEngineVersion, 12);
