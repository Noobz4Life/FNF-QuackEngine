...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			...
			[''],
			['Quack Engine'],
			['nubz4lif',		'nubz4lif',		'Main Programmer of Quack Engine',										'https://twitter.com/nubz4lif',			'0FFFA7'],
			[''],
			...
			['Tahir',				'tahir',			'Implementing & Maintaining SScript and Other PRs\nDeveloper of Kade Engine + Kade Input',			 'https://twitter.com/tahirk618',		'A04397'],
